...
% =====================================
disp(' ------------------------------------------------------------------------')
disp(' HEUN METHOD FOR SOLVING AN EDO')
% =====================================
% Function
...
hold on
title('HEUN METHOD FOR SOLVING AN ORDINARY DIFFERENTIAL EQUATION')
plot(x,y_verdadero,'r-o',LineWidth=2)
legend('Y_RK Heun','Y_True')
